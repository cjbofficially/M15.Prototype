...
{
    public class StandardTransmissiveShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent transmissionText = EditorGUIUtility.TrTextContent("Transmission", "(Shadow Color)");
        ...
        // test
        MaterialProperty transmissionMap = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            // test
            transmissionMap = FindProperty("_TransparencyLM", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                // test
                DoTransmissionArea();
                //m_MaterialEditor.TexturePropertySingleLine(Styles.transmissionText, transmissionMap);
        ...
        {
            m_MaterialEditor.TexturePropertySingleLine(Styles.albedoText, albedoMap, /*test*/ /*transmissionMap,*/ albedoColor);
